...
# Change the whitespace settings value for navbar
...
tell application "Terminal"
  ...
  repeat with ProfileName in ProfilesNames
      set font name of settings set ProfileName to "FiraCode-Retina"
      set font size of settings set ProfileName to 13
  end repeat

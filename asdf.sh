...
install_asdf_package "java" "false" "temurin-17.0.1+12"
install_asdf_package "java" "true" "zulu-17.30.15"

# Node.JS
bash -c '${ASDF_DATA_DIR:=$HOME/.asdf}/plugins/nodejs/bin/import-previous-release-team-keyring'
bash -c '${ASDF_DATA_DIR:=$HOME/.asdf}/plugins/nodejs/bin/import-release-team-keyring'
install_asdf_package "nodejs" "true" "16.13.0"
install_asdf_package "yarn"
yarn global add diff2html-cli
asdf reshim nodejs

# Python
install_asdf_package "python" "false" "3.10.0"
